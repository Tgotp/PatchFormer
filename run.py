...
if __name__ == '__main__':
    ...
    # data loader
    parser.add_argument('--data', type=str, default='Icing_128_20/', help='dataset type')
    parser.add_argument('--data_path', type=str, default='./data/Graph_BladeIcing/', help='data path of the data file')
    ...
    parser.add_argument('--patch_size_list', nargs='+', type=list, default=[16,12,8,32,12,8,6,4,8,6,4,2])
